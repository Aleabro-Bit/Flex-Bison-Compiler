...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUM = 3,                        /* NUM  */
  YYSYMBOL_BINARY = 4,                     /* BINARY  */
  YYSYMBOL_ROMAN = 5,                      /* ROMAN  */
  YYSYMBOL_STR = 6,                        /* STR  */
  YYSYMBOL_IDENTIFIER = 7,                 /* IDENTIFIER  */
  YYSYMBOL_FUNC = 8,                       /* FUNC  */
  YYSYMBOL_OPERATOR = 9,                   /* OPERATOR  */
  YYSYMBOL_FUNCTION = 10,                  /* FUNCTION  */
  YYSYMBOL_WHETHER = 11,                   /* WHETHER  */
  YYSYMBOL_THEN = 12,                      /* THEN  */
  YYSYMBOL_OTHERWISE = 13,                 /* OTHERWISE  */
  YYSYMBOL_WHEN = 14,                      /* WHEN  */
  YYSYMBOL_LET = 15,                       /* LET  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "BINARY",
  "ROMAN", "STR", "IDENTIFIER", "FUNC", "OPERATOR", "FUNCTION", "WHETHER",
  "THEN", "OTHERWISE", "WHEN", "LET", "FROM", "TO", "STEP", "CMP", "'='",
  "'+'", "'-'", "'*'", "'/'", "'|'", "UMINUS", "';'", "$accept", "START",
  "TERM", YY_NULLPTR
};
